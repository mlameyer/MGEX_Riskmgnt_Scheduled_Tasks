...
class ImportCGMPostAM {
    ...
    public ImportCGMPostAM(Properties prop) 
    {
        this.prop = prop;
    }

    void csvImportCGMPost() {
        String Timevalue = prop.getProperty("importCGMPostAMExecute");
        ...
        scheduler.scheduleAtFixedRate(new ImportCGMPostAM.RunnableJob(), initalDelay, 86400, SECONDS);
    }
