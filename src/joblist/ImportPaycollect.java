...
class ImportPaycollect {
    ...
    public ImportPaycollect(Properties prop) 
    {
        this.prop = prop;
    }

    void csvImportPaycollect() {
        String Timevalue = prop.getProperty("ImportPaycollectExecute");
        ...
        scheduler.scheduleAtFixedRate(new ImportPaycollect.RunnableJob(), initalDelay, 86400, SECONDS);
    }
